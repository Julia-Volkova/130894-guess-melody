...
// const firstGameScreen = `<section class="main main--level main--level-artist">
...
// const answers = firstGameScreenElement.querySelectorAll(`.main-answer`);
...
// const playAgainLink = firstGameScreenElement.querySelector(`.play-again__wrap`);
